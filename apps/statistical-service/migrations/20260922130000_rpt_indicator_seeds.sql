...
VALUES
    ('00000000-0000-0000-0000-000000000010', '20000.01', 'Tổng số dư tiền gửi', 'VND', 'Huy động vốn', 'seed',
     ...
     '{"type":"sum","fact":"rpt_fact_deposit_contract_daily","column":"principal_minor","filter":{"status":"ACTIVE"},"as_of":"period_end","scale":100}',
     '["org","time"]', 'amount', 2),
    ...
    ('00000000-0000-0000-0000-000000000010', '30000.01', 'Tổng dư nợ cho vay', 'VND', 'Tín dụng', 'seed',
     ...
     '{"type":"sum","fact":"rpt_fact_loan_agreement_daily","column":"outstanding_amt_minor","filter":{"status":"ACTIVE"},"as_of":"period_end","scale":100}',
    ...
    ('00000000-0000-0000-0000-000000000010', '30020.01', 'Dư nợ xấu (nhóm 3-5)', 'VND', 'Tín dụng', 'seed',
     ...
     '["rpt_fact_loan_agreement_daily"]',
     '{"type":"sum","fact":"rpt_fact_loan_agreement_daily","column":"outstanding_amt_minor","filter":{"status":"ACTIVE","debt_group_code":["GROUP_3","GROUP_4","GROUP_5"]},"as_of":"period_end","scale":100}',
     '["org","time"]', 'amount', 2),
    ...
    ('00000000-0000-0000-0000-000000000010', '30021.01', 'Dự phòng rủi ro tín dụng', 'VND', 'Tín dụng', 'seed',
     ...
     '["rpt_fact_loan_agreement_daily"]',
     '{"type":"sum","fact":"rpt_fact_loan_agreement_daily","column":"provision_amt_minor","filter":{"status":"ACTIVE"},"as_of":"period_end","scale":100}',
     '["org","time"]', 'amount', 2),
    ...
    ('00000000-0000-0000-0000-000000000010', '40000.01', 'Tổng nguồn vốn huy động', 'VND', 'Nguồn vốn', 'seed',
     ...
     '{"type":"sum","fact":"rpt_fact_capital_contract_daily","column":"amount_minor","filter":{"status":"ACTIVE"},"as_of":"period_end","scale":100}',
    ...
    ('00000000-0000-0000-0000-000000000010', '50000.01', 'Tổng giá trị tài sản bảo đảm', 'VND', 'TSĐB', 'seed',
     ...
     '{"type":"sum","fact":"rpt_fact_loan_collateral_daily","column":"coll_value_minor","as_of":"period_end","scale":100}',
